        ...
        <div class="container">
            ...
            <div class="navbar">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/heros">Heros</a></li>
            ...
            <div>
                ...
                <c:forEach var="hero" items="${heros}">
                    <a href="${pageContext.request.contextPath}/hero${hero.id}"><c:out value="${hero.id}:${hero.name}"/></a>
                </c:forEach>
            </div>
