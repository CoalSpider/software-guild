...
<html>
    ...
    <body>
        <div class="container">
            ...
            <sf:form method="POST" action="${pageContext.request.contextPath}/saveNewOrganization" modelAttribute="organization">
                <div class="row">
                    <div class="col-sm-4">
                ...
                <div class="row">
                    <sf:button type="submit">Save Organization</sf:button>
                </div>
            </sf:form>
        </div>
