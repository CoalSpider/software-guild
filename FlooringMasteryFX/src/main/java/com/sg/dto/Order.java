...
public class Order {
    ...
    public String getName(){
        return getCustomerName().replaceAll("\\[CANCELED\\]", "");
    }
    ...
    public String getProductCost() {
        return "$" + getProduct().getCostPerSquareFoot().toPlainString();
    }

    public String getProductLaborCost() {
        return "$" + getProduct().getLaborCostPerSquareFoot().toPlainString();
    }
    ...
    public String getStateTaxRate() {
        return getState().getTaxRate().toPlainString() + "%";
    }

    public String getArea() {
        return getAreaInSquareFeet().toPlainString();
    }

    public String getLaborTotal() {
        return "$" + getLaborCost().toPlainString();
    }

    public String getMaterialTotal() {
        return "$" + getMaterialCost().toPlainString();
    }

    public String getTaxTotal() {
        return "$" + getTax().toPlainString();
    }

    public String getOrderTotal() {
        return "$" + getTotal().toPlainString();
    }
