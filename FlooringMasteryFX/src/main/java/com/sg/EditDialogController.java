...
public class EditDialogController implements Initializable {
    ...
    /**
     * Sets the dialog's parts to the given order
     * @param order the order to use
     */
    public void setDialog(Order order){
        stateChoices.setValue(order.getState());
        productChoices.setValue(order.getProduct());
        area.setText(order.getAreaInSquareFeet().toPlainString());
