...
public class AllTheMaths {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(8043.52 - 4.2 + 23.0 / 56.0 * -76); // 8008.052321428572
        // without decimals = 8039

        System.out.print("11111 modulus 3 minus 67 minus 1 plus 9 is: ");
        System.out.println(1111 % 3 - 67 - 1 + 9); // -58
        ...
        System.out.println(22 * 3 - 1 + 4 * 6 - -9); //98

        System.out.print("Is 67 greater than 4 * 5? ");
        System.out.println(67 > 4*5); // true

        System.out.print("Is 78 less than than 4 * 5? ");
        System.out.print(78 < 4*5); // false
    }
}
