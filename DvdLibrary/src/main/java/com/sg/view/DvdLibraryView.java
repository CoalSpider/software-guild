...
public class DvdLibraryView {
     ...
     */
    /**
     * returns -1 for invalid command choices or non number input*
     */
    ...
    public Dvd askForDvdInfo(String title) {
        LocalDate releaseDate = askForReleaseDate();
    ...
    private LocalDate askForReleaseDate() {
        String input = io.readString("Enter release date: mm/dd/yyyy ");
        do {
            try {
                return LocalDate.parse(input, Util.DATE_FORMAT);
            } catch (DateTimeParseException e) {
                input = io.readString("Not a valid date. Date must be in form: mm/dd/yyyy");
            }
        } while (true);
    }
    ...
    public LocalDate askForNewReleaseDate(LocalDate current) {
        String input = io.readString("Current release date is: " + current.format(Util.DATE_FORMAT) +". Enter a new relase date");
        do {
            try {
                return LocalDate.parse(input, Util.DATE_FORMAT);
            } catch (DateTimeParseException e) {
    ...
    public void displayDvd(Dvd dvd) {
        ...
        io.print("Release Date:\t" + dvd.getReleaseDate().format(Util.DATE_FORMAT));
    ...
    public void displayErrorMessage(String message) {
     ...
     /*
     * =========================================================================
     * Display search DVD library stuff
     * =========================================================================
     */
}
